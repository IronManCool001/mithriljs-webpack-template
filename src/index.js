...
const App = () => {
    return {
        view: () => (
            <main>
                <h2>Hello World!</h2>
                <svg id="mithril" viewBox="0 0 38.044 38.044" style="enable-background:new 0 0 38.044 38.044;">
                    <g>
                        <g>
            ...
            <g>
                ...
                <a href="https://mithril.js.org/index.html#getting-started">Read The Docs.</a>
            </main>
        )
    }
}

m.render(document.getElementById('root'),<App/>)
